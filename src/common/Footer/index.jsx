            ...
            <div className={styles.info_main}>
              <div className="row">
                <div className="col-lg-5 col-md-6 col-12 mb-4 mb-md-0">
                  ...
                  <p>
                    VLS Law Academy helps law graduates and advocates build
                    practical legal knowledge for judicial services, law
                    practice, and professional growth through structured legal
                    training and real-world practice guidance.
                  </p>
                </div>
